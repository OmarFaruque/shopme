...
if (is_admin()){
  ...
  $config = array(
    ...
    'pages' => array('product-category', 'service-support'),        // taxonomy name, accept categories, post_tag and custom taxonomies
  ...
  //Image field
  $my_meta->addImage($prefix.'image_field_id',array('name'=> __('Category Image','tax-meta')));
